@include('includes.header')
    ...
    <section class="hero-area hero-post-slides owl-carousel">
        <!-- Single Hero Slide -->
        <div class="single-hero-slide bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(img/bg-img/brasil_bandeira.jpg);">
            <!-- Post Content -->
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            <h2 data-animation="fadeInUp" data-delay="100ms">Movimento Conservador Brasileiro</h2>
                            <p data-animation="fadeInUp" data-delay="300ms">Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet</p>
                            <a href="join" class="btn crose-btn" data-animation="fadeInUp" data-delay="500ms">Participe</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Single Hero Slide -->
        <div class="single-hero-slide bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(img/bg-img/bolsonaro_slogan.jpg);">
            <!-- Post Content -->
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            <h2 data-animation="fadeInUp" data-delay="100ms">Presidente Bolsonaro</h2>
                            <p data-animation="fadeInUp" data-delay="300ms">Brasil acima de tudo, Deus acima de todos.</p>
                            <a href="contact" class="btn crose-btn" data-animation="fadeInUp" data-delay="500ms">Contato</a>
                        </div>
                    </div>
                </div>
            </div>
